use crate::build::{
    ...
    op::{
        BinaryOp, BranchTableCopies, BranchTableOp, CallIndirectOp, CmpBranchOp, GenericOp,
        GlobalGetOp, GlobalSetOp, LoadOp, MemoryOperand, OffsetOperand, OperandKind, ReplaceLaneOp,
        SelectOp, StoreOp, TableGetOp, TableSetOp, TernaryOp, UnaryOp, V128ExtractLaneOp,
    },
