use crate::build::{
    ...
    ident::Ident,
    op::{
        BinaryOp, BinaryOpCaps, BranchTableCopies, BranchTableOp, CallIndirectOp, CallKind,
        CmpBranchOp, Field, GenericOp, GlobalGetOp, GlobalSetOp, LoadKind, LoadOp, MemoryOperand,
        OffsetOperand, OperandKind, ReplaceLaneOp, SelectOp, StoreKind, StoreOp, TableGetOp,
        TableSetOp, TernaryOp, TernaryOpKind, UnaryOp, V128ExtractLaneOp, Wrapped,
    },
