...
use self::{
    ...
    op::{
        BinaryOp, BinaryOpVt, CommutativeBinaryOp, CommutativeBinaryOpVt, LoadOpVt, StoreOpVt,
        UnaryOp, UnaryOpVt,
    },
    stack::{
        BlockControlFrame, ControlFrame, ControlFrameBase, ControlFrameKind, ElseControlFrame,
        ElseReachability, IfControlFrame, IfReachability, LocalOperand, Location, LoopControlFrame,
        Operand, ResolvedOperand, Stack, StackAllocations,
    },
...
use crate::{
    ...
    engine::{
        BlockType, CompiledFuncEntry, TranslationError,
        code_map::FuncEntry,
        translator::{
            WasmTranslator,
            comparator::{
    ...
    ir::{
        self, Address, BoundedSlotSpan, BranchOffset, FixedSlotSpan, Offset, Offset16, Op, Slot,
        SlotAndReg, SlotSpan,
        index::{self, Memory},
    },
