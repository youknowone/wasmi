...
mod core {
    ...
    pub use wasmi_core::{
        ...
        Global as CoreGlobal, IndexType, IntoShiftAmount, LimiterError, Memory as CoreMemory,
        MemoryType as CoreMemoryType, MemoryTypeBuilder as CoreMemoryTypeBuilder, RawRef, RawVal,
        ReadAs, ResourceLimiterRef, ShiftAmount, Table as CoreTable, TableType as CoreTableType,
        Typed, TypedRawRef, TypedRawVal, WriteAs, hint, wasm,
    };
}
